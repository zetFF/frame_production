...
export default function Home() {
  ...
  // NEW: refs for decorated sections
  ...
  useEffect(() => {
    ...
    if (reveal) {
      ...
      if (image && revealText) {
        gsap.fromTo(reveal,
          { clipPath: "inset(10% 10% 10% 10% round 32px)" },
          {
            ...
            ease: "power2.inOut",
            scrollTrigger: { trigger: reveal, start: "top bottom", end: "top top", scrub: true },
          },
        );
      ...
      // ============================================
      // 🎨 REVEAL DECOR ANIMATIONS
      // ============================================
      const revealDecor = revealDecorRef.current;
      if (revealDecor) {
        const shapes = revealDecor.querySelectorAll(".reveal-shape");
        const labels = revealDecor.querySelectorAll(".reveal-label");
    ...
    if (parallax) {
      ...
      if (parallaxDecor) {
        ...
        decorItems.forEach((item, i) => {
          const dir = i % 3 === 0 ? -80 : i % 3 === 1 ? 80 : -50;
          gsap.to(item, {
            y: dir,
            ease: "none",
            scrollTrigger: {
    ...
    if (floatingObjs) {
      ...
      items.forEach((item, i) => {
        ...
        gsap.to(item, {
          y: speed, ease: "none",
          scrollTrigger: { trigger: floatingObjs, start: "top bottom", end: "bottom top", scrub: true },
        });
        gsap.to(item, {
          rotation: i % 2 === 0 ? 45 : -45, ease: "none",
          scrollTrigger: { trigger: floatingObjs, start: "top bottom", end: "bottom top", scrub: true },
        });
      });
    ...
    if (morph) {
      ...
      Array.from(cards).forEach((card, i) => {
        gsap.to(card, {
          y: (i % 3) * 40 - 40, ease: "none",
          scrollTrigger: { trigger: morph, start: "top bottom", end: "bottom top", scrub: true },
        });
      });
    ...
    if (windowReveal) {
      gsap.fromTo(windowReveal,
        { clipPath: "polygon(0% 0%, 0% 0%, 0% 0%, 0% 0%)" },
        {
          ...
          ease: "power3.inOut",
          scrollTrigger: { trigger: windowReveal, start: "top 85%", end: "top 20%", scrub: 1.5 },
        },
      );
  ...
  return (
    <main className="bg-black text-white overflow-hidden cursor-none">
      ...
      {/* ============================================ */}
      {/* 🔥 FULLSCREEN REVEAL — dengan dekorasi       */}
      {/* ============================================ */}
      <section
        ref={revealRef}
      ...
      >
        ...
        <div ref={revealDecorRef} className="absolute inset-0 z-20 pointer-events-none overflow-hidden">
          ...
          {/* Lingkaran kecil dekoratif tersebar */}
      ...
      <section className="h-screen flex items-center justify-center px-10 relative overflow-hidden">
        ...
        <div ref={splitDecorRef} className="absolute inset-0 pointer-events-none">
          ...
          {/* Garis horisontal dekoratif atas & bawah teks */}
      ...
      <section className="h-[150vh] relative flex items-center justify-center overflow-hidden">
        <div ref={parallaxRef} className="w-full h-full relative">
          ...
          <div ref={parallaxDecorRef} className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            {/* Label metadata pojok kiri atas */}
            ...
            {/* Label metadata pojok kanan bawah */}
            ...
            {/* Cross hair pojok kiri tengah */}
            <div className="px-decor-item absolute top-1/2 left-[5%] -translate-y-1/2 opacity-15">
              <div className="absolute w-5 h-px bg-white top-0 left-0" />
              <div className="absolute w-px h-5 bg-white top-[-10px] left-[10px]" />
            </div>
          ...
          <div className="parallax-fg relative z-10 flex flex-col items-center justify-center h-full gap-6">
            ...
            {/* Tiga angka statistik mini di bawah */}
      ...
      >
        ...
        <div className="overflow-hidden mb-20">
          <h2 className="footer-big-text text-6xl md:text-[10vw] font-bold leading-none tracking-tighter">
            ...
            <span
              ...
              style={{ WebkitTextStroke: "1px rgba(255,255,255,0.3)" } as React.CSSProperties}
            >
              extraordinary.
            </span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-neutral-600 text-sm leading-relaxed tracking-tighter max-w-xs">
              We design and build digital experiences that move people — literally and emotionally.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3">
              {["Projects", "Case Studies", "Selected Works", "Awards"].map((item) => (
                <li key={item}>
                  <a href="#" className="footer-link text-sm text-neutral-400 hover:text-white transition-colors duration-300">{item}</a>
                </li>
              ))}
            </ul>
          </div>
              ...
              {["Instagram", "Twitter / X", "LinkedIn", "Dribbble"].map((item) => (
                <li key={item}>
                  <a href="#" className="footer-link text-sm text-neutral-400 hover:text-white transition-colors duration-300 inline-flex items-center gap-2 group">
                    {item}
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-purple-400 text-xs">↗</span>
                  </a>
                </li>
              ))}
            </ul>
